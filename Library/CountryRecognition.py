...
def countryRecognition(df):
    ...
    #Function that recognizes if the variable is a city of a country.
    #In the first case, returns the tuple(country_found, city_found).
    #In the second case, returns the tuple(country_found, ' ').
    ...
    #Lambda function creates the tuple (country, city) in a new column
